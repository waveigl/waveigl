...
export default function MainApp({ view }: { view: 'live' | 'links' | 'dashboard' }) {
  ...
  // Gestor da live: owner, streamer e admin veem os painéis de gerenciamento da live
  const isLiveManager = !!user && (isOwner(user.role) || isAdmin(user.role))
          ...
          >
            ...
            {isChatVisible && (
              <>
                ...
                {isLiveManager && moderationActions.length > 0 && (
